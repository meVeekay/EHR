 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://com.cubic.net/personservice/1.0", wsdlLocation = "file:/D:/develope/ehr-soap-api/src/main/resources/META-INF/wsdl/PersonService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://com.cubic.net/personservice/1.0", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/develope/ehr-soap-api/src/main/resources/META-INF/wsdl/PersonService.wsdl");
    ...
    public PersonServicePortType getPersonServicePort() {
        return super.getPort(new QName("http://com.cubic.net/personservice/1.0", "PersonServicePort"), PersonServicePortType.class);
    }
    ...
    public PersonServicePortType getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com.cubic.net/personservice/1.0", "PersonServicePort"), PersonServicePortType.class, features);
    }
